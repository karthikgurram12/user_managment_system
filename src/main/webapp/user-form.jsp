			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>User Name</label> <input type="text"
						...
						name="name" required="required" minlength="3" maxlength="12">
				</fieldset>
				...
				<fieldset class="form-group">
					...
					<select value="<c:out value='${user.country}' />" name="country" class="form-control" style="width: 250px;" required="required">
